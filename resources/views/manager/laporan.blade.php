...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/manager/laporan.css') }}">
@endpush
...
<div class="laporan-page">
    ...
    <div class="filter-card">
        ...
        <form action="/laporan-manager" method="GET">
            <div class="form-grid">
    ...
    <div class="preview-card">
        <div class="preview-top">
            ...
            <a href="/download-laporan-manager?bulan={{ $bulan }}&jenis_limbah={{ $jenisData }}"
                class="download-btn">
