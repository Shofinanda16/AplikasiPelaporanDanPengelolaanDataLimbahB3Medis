...
<head>
    ...
    <!-- /* CSS LAYOUT */ -->
    <link rel="stylesheet" href="{{ asset('css/layouts/manager.css') }}">
...
<div class="layout">
    ...
    <aside class="sidebar">
        <ul>
            ...
            <li>
                <a href="/rekapitulasi-manager"
                   class="{{ request()->is('rekapitulasi-manager') ? 'active' : '' }}">
            ...
            <li>
                <a href="/laporan-manager"
                   class="{{ request()->is('laporan-manager') ? 'active' : '' }}">
